      ...
      >
        <div style={{ display: 'grid', gap: '1.5rem' }}>
          <div>
            ...
            />
            <p style={{ fontSize: '0.75rem', color: '#6b7280', marginTop: '0.25rem' }}>Event code cannot be changed</p>
          </div>
      ...
      >
        <div style={{ display: 'grid', gap: '1.5rem' }}>
          <div style={{ 
            ...
            <div style={{ color: '#dc2626', fontSize: '1.125rem', fontWeight: 'bold', marginBottom: '0.5rem' }}>
