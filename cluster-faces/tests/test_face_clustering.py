...
def validate_cluster_purity(labels, subject_names):
    ...
    overall_purity = correct_assignments / total_assignments if total_assignments > 0 else 1.0
...
def test_dbscan_clustering(face_embeddings):
    ...
    is_pure, purity_score, cluster_stats = validate_cluster_purity(labels, subject_names)
